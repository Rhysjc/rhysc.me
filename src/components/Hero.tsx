...
export const Hero: React.FC = () => {
  return (
    <div className='mt-6 md:mt-12 text-zinc-800 dark:text-zinc-100'>
      <h1 className='font-semibold text-6xl md:text-9xl'>Hi, I'm <span className='relative before:block before:absolute before:inset-x-0 before:top-6 md:before:top-14 before:bottom-3 before:bg-purple-600 before:-skew-x-6 before:-skew-y-3 hover:before:scale-75 before:transition-transform'><span className='relative'>Rhys</span></span></h1>
