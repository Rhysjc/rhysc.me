...
export const Skills: React.FC = () => {
  ...
  return (
    <div>
      <h2 className='font-semibold text-3xl lg:text-4xl text-zinc-800 dark:text-zinc-100 mt-4'>Some of the tech I've worked with</h2>
      <input type="text" placeholder='Filter' className='bg-transparent outline-none text-zinc-800 dark:text-zinc-100 mb-1 w-full placeholder:text-zinc-400' value={filterText} onChange={e => setFilterText(e.target.value)} />
